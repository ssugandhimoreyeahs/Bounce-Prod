...
import { Header, Root, CustomButton, CustomTextinput, FloatingInput, InputBox } from '@components'
...
import { AgeField, SwitchButton, DollarField } from '../../../components/BreakedComponents'
        ...
        <Root>
            <View style={styles.container}>
                <ScrollView style={{ flex: 1 }} contentContainerStyle={{ flexGrow: 1 }} >
                    ...
                    />
                    {/* First Section */}
                    <View style={{ paddingHorizontal: 10, marginBottom: 3, backgroundColor: '#fff',paddingBottom:20 }}>
                        <FloatingInput
                        ...
                        {picture == null ?
                            <TouchableOpacity onPress={handleImage} style={{  marginVertical: getHp(40), justifyContent: 'center', alignItems: 'center' }}>
                                 <View style={{ borderRadius: 100, elevation: 10, backgroundColor: '#fff', }}>
                                <UploadBlue height={getHp(100)} width={getHp(100)} />
                            </View>
                                <Text style={{
                                    fontSize: FONTSIZE.Text14, color: '#000', marginTop: 10, fontFamily: 'AvenirNext',
                                }}>
                                    {"Upload Media"}
                                </Text>
                            </TouchableOpacity>
                            ...
                            <>
                                <View style={{ marginVertical: getHp(23), justifyContent: 'center', alignItems: 'center' }}>
                                    <TouchableOpacity onPress={() => openFooter(true)} style={{ marginVertical: 30 }}>
                                        ...
                                        <View >
                                            <UploadBlue height={50} width={50} style={{ position: 'absolute', bottom: -25, left: 55, resizeMode: 'contain' }} />
                                        </View>
                                        {footer ?
                                            <ImageFooter />
                                            : null
                    ...
                    {/* Second Section */}
                    <View style={{ paddingHorizontal: 10, marginVertical: 3, backgroundColor: '#fff', justifyContent: 'center', paddingVertical: 20 }}>
                        {/* <View style={styles.eventContainer}> */}
                        <Text style={[styles.headerTitle, { fontSize: FONTSIZE.Text20, marginRight: 5 }]}>
                            {"Event Settings"}
                        </Text>
                    ...
                    {/* Tickets Section */}
                    <View style={{ paddingHorizontal: 10, marginTop: 3, backgroundColor: '#fff', justifyContent: 'center', paddingVertical: 20 }}>
                        <Text style={[styles.headerTitle, { fontSize: FONTSIZE.Text20, marginRight: 5, marginBottom: 10 }]}>
                            {"Tickets"}
                        </Text>
                        ...
                        <View style={[styles.eventContainer, { justifyContent: 'space-between' }]}>
                            ...
                            <TextInput
                                ...
                                placeholder={"$0"}
                                style={[styles.textInput, { width: '35%', textAlign: 'center', fontSize: FONTSIZE.Text18, }]}
                            />
                        </View>
                        <View style={[styles.eventContainer, { justifyContent: 'space-between' }]}>
                            <Text style={[styles.headerTitle, { fontSize: FONTSIZE.Text20, marginRight: 5, }]}>
                        ...
                        <TouchableOpacity style={{ marginTop: 10, backgroundColor: '#F2F5F6', borderRadius: 9 }}>
                            <Text style={[styles.headerTitle, { fontSize: FONTSIZE.Text18, color: '#1FAEF7', paddingVertical: 10, textAlign: 'center' }]} >
                                {"Add Ticket Type"}
                            </Text>
                        </TouchableOpacity>
